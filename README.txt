...
They include convenience mthods for managed a database, mongrel, nginx or other services.
...
To use remote_filtered_cache, simply:

set :deploy_via, :remote_filtered_cache